      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 py-20 md:min-h-[72vh] md:grid-cols-2 md:py-24">
        ...
        <div className="max-w-xl">
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight md:text-5xl">
            Hi, I&apos;m <span className="text-secondary">Zdenko</span>
            <TypeAnimation
              sequence={[
                " — Web design & development", 1000,
                " — AI enthusiast", 1000,
                " — Always a learner", 1000,
              ]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
          ...
          <p className="mt-5 text-pretty text-white/80 text-center md:text-left">
            I&apos;m a Computer Engineering student who builds at the intersection of AI and full-stack development.
            I learn fast and ship consistently—turning ideas into working products through curiosity and disciplined work.
            Whether it&apos;s mastering a new framework, prototyping research ideas, or building production-ready apps,
            I bring a builder&apos;s mindset and thrive on real challenges.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-4 text-sm text-white/60">
            <span className="rounded-lg border border-white/10 bg-white/5 px-3 py-1">Toluca, MX</span>
            <span className="rounded-lg border border-white/10 bg-white/5 px-3 py-1">JS/TS, CSS, Python</span>
            <span className="rounded-lg border border-white/10 bg-white/5 px-3 py-1">React, Next.js, Node.js</span>
          </div>
        </div>
            ...
            {hasPhoto ? (
              ...
              <div className="absolute inset-0 rounded-[2rem] ring-1 ring-white/10">
                ...
                <div className="relative z-10 flex h-full items-center justify-center">
                  <span className="text-6xl font-black tracking-tight text-white/90">ZA</span>
                </div>
              </div>
            )}
          </div>
